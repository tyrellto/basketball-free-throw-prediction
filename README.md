...
1. **Data Preprocessing**: [code](https://github.com/tyrellto/Giannis-Free-Throw-Prediction/blob/main/sorting.ipynb)
   ...
   - The figure below shows the high level process, where each recording for a person has all the time points for all joints flattened to one singular feature vector:
  <p align="center">
